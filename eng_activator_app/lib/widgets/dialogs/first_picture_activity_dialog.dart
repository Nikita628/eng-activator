...
class FirstPictureActivityDialog extends StatelessWidget {
  FirstPictureActivityDialog({Key? key}) : super(key: key);
    ...
    return SimpleDialog(
      ...
      title: Row(
        children: [
          ...
          Flexible(
            child: const Text(
              "You've created your first picture activity!",
      ...
      children: [
        ...
        const Text(
          "Write a story about the given picture.",
